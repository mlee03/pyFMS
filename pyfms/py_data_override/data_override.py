...
def set_time(
    ...
    _data_override_set_time = _lib.cFMS_data_override_set_time
...
def override_scalar(
    ...
    _data_override_scalar = _lib.cFMS_data_override_0d_cdouble
...
def override(
    ...
    if data_type is np.float32:
        if nshape == 2:
            _data_override = _lib.cFMS_data_override_2d_cfloat
        if nshape == 3:
            _data_override = _lib.cFMS_data_override_3d_cfloat
    elif data_type is np.float64:
        if nshape == 2:
            _data_override = _lib.cFMS_data_override_2d_cdouble
        if nshape == 3:
            _data_override = _lib.cFMS_data_override_3d_cdouble
    else:
        # add cFMS_end
