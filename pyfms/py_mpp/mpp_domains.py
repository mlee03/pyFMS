...
def setlib(libpath: str, lib: type[ctypes.CDLL]):
    _libpath = libpath
    _lib = lib
...
def get_domain_pelist(domain_id: int) -> list[int]:
    ...
    npes = ctypes.c_int.in_dll(_lib, "cFMS_pelist_npes")
...
def set_current_nest_domain(nest_domain_id: int):
    _cfms_set_current_nest_domain = _lib.cFMS_set_current_nest_domain
