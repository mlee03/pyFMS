...
class mpp_domains():
    ...
    @classmethod
    def get_layout(cls, domain_id: int = None) -> NDArray:
    ...
    @classmethod
    def get_domain_pelist(cls, domain_id: int = None) -> NDArray:
    ...
    @classmethod
    def set_current_domain(cls, domain_id: int = None):
    ...
    @classmethod
    def set_current_nest_domain(cls, nest_domain_id: int = None):
