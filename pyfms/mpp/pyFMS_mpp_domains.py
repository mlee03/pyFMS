...
class pyFMS_mpp_domains(pyFMS_mpp):
    ...
    def pyfms_define_domains(
            self, global_indices: List[int], layout: List[int], domain_id: Optional[int] = None,
            pelist: Optional[List[int]]=None, xflags: Optional[int]=None, yflags: Optional[int]=None,
            xhalo: Optional[int]=None, yhalo: Optional[int]=None, xextent: Optional[List[int]]=None,
            yextent: Optional[List[int]]=None, maskmap: Optional[npt.NDArray[np.bool_]]=None,
            name: Optional[str]=None, symmetry: Optional[bool]=None, memory_size: Optional[List[int]]=None,
            whalo: Optional[int]=None, ehalo: Optional[int]=None, shalo: Optional[int]=None,
            nhalo: Optional[int]=None, is_mosaic: Optional[bool]=None, tile_count: Optional[int]=None,
            tile_id: Optional[int]=None, complete: Optional[bool]=None, x_cyclic_offset: Optional[int]=None,
        ...
        _cfms_define_domains.argtypes = [
            global_indices_t, layout_t, domain_id_t, pelist_t, xflags_t, yflags_t,
            xhalo_t, yhalo_t, xextent_t, yextent_t, maskmap_t, name_t, symmetry_t,
            memory_size_t, whalo_t, ehalo_t, shalo_t, nhalo_t, is_mosaic_t,
            tile_count_t, tile_id_t, complete_t, x_cyclic_offset_t, y_cyclic_offset_t
        ]

        _cfms_define_domains.restype = None

        _cfms_define_domains(
            global_indices_p, layout_p, domain_id_p, pelist_p, xflags_p, yflags_p,
            xhalo_p, yhalo_p, xextent_p, yextent_p, maskmap_p, name_p, symmetry_p,
            memory_size_p, whalo_p, ehalo_p, shalo_p, nhalo_p, is_mosaic_p,
            tile_count_p, tile_id_p, complete_p, x_cyclic_offset_p, y_cyclic_offset_p
        )
    ...
    def pyfms_define_nest_domain(
            self, num_nest: int, ntiles: int, nest_level: List[int], tile_fine: List[int], tile_coarse: List[int],
            istart_coarse: List[int], icount_coarse: List[int], jstart_coarse: List[int], jcount_coarse: List[int],
            npes_nest_tile: List[int], x_refine: List[int], y_refine: List[int], nest_domain_id: Optional[int]=None,
            extra_halo: Optional[int]=None, name: Optional[str]=None,
    ):
        ...
        _cfms_define_nest_domain.argtypes = [
            num_nest_t, ntiles_t, nest_level_t, tile_fine_t, tile_coarse_t, istart_coarse_t, 
            icount_coarse_t, jstart_coarse_t, jcount_coarse_t, npes_nest_tile_t, x_refine_t,
            y_refine_t, nest_domain_id_t, extra_halo_t, name_t
        ]
        _cfms_define_nest_domain.restype = None

        _cfms_define_nest_domain(
            num_nest_p, ntiles_p, nest_level_p, tile_fine_p, tile_coarse_p, istart_coarse_p,
            icount_coarse_p, jstart_coarse_p, jcount_coarse_p, npes_nest_tile_p, x_refine_p, 
            y_refine_p, nest_domain_id_p, extra_halo_p, name_p
        )
    ...
    #         self, domain_id: Optional[int]=None, xbegin: Optional[int]=None, xend: Optional[int]=None,
    #         ybegin: Optional[int]=None, yend: Optional[int]=None, xsize: Optional[int]=None,
    #         ysize: Optional[int]=None, x_is_global: Optional[bool]=None, y_is_global: Optional[bool]=None,
    ...
    #         domain_id_t, xbegin_t, xend_t, ybegin_t, yend_t, xsize_t,
    #         ysize_t, x_is_global_t, y_is_global_t, tile_count_t
    #     ]
    #     _cfms_set_compute_domain.restype = None

    #     _cfms_set_compute_domain(
    #         domain_id_p, xbegin_p, xend_p, ybegin_p, yend_p, xsize_p,
    #         ysize_p, x_is_global_p, y_is_global_p, tile_count_p
    #     )

    # def pyfms_set_data_doman(
    #         self, domain_id: Optional[int]=None, xbegin: Optional[int]=None, xend: Optional[int]=None,
    #         ybegin: Optional[int]=None, yend: Optional[int]=None, xsize: Optional[int]=None,
    #         ysize: Optional[int]=None, x_is_global: Optional[bool]=None, y_is_global: Optional[bool]=None,
    #         tile_count: Optional[int]=None,
    ...
    #         self, domain_id: Optional[int]=None, xbegin: Optional[int]=None, xend: Optional[int]=None,
    #         ybegin: Optional[int]=None, yend: Optional[int]=None, xsize: Optional[int]=None,
    #         ysize: Optional[int]=None, tile_count: Optional[int]=None,
    # ):
    ...
    #         domain_id_t, xbegin_t, xend_t, ybegin_t, yend_t, xsize_t,
    #         ysize_t, tile_count_t
    #     ]
    #     _cfms_set_global_domain.restype = None

    #     _cfms_set_global_domain(
    #         domain_id_p, xbegin_p, xend_p, ybegin_p, yend_p, xsize_p,
    #         ysize_p, tile_count_p
    #     )

    # def pyfms_get_domain_layout(self, layout: List[int], domain_id: Optional[int]=None):

    # def pyfms_get_domain_pelist(self, pelist: List[int], domain_id: Optional[int], pos: Optional[int]):
    #     _cfms_get_domain_pelist = self.clibFMS.cFMS_get_domain_pelist

    #     pelist_p, pelist_t = setarray_Cint32(pelist)
    #     domain_id_p, domain_id_t = setscalar_Cint32(domain_id)
    #     pos_p, pos_t = setscalar_Cint32(pos)

    #     _cfms_get_domain_pelist.argtypes = [pelist_t, domain_id_t, pos_t]
    #     _cfms_get_domain_pelist.restype = None

    #     _cfms_get_domain_pelist(pelist_p, domain_id_p, pos_p)
