...
def test_getset_domains():
    ...
    * * (2,2) (3,2) (4,2) (5,2) * *
    ...
    compute = pyfms.mpp_domains.get_compute_domain(domain_id=domain_id, whalo=whalo, shalo=shalo)
    data = pyfms.mpp_domains.get_data_domain(domain_id=domain_id, whalo=whalo, shalo=shalo)
