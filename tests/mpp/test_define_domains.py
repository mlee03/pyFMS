...
def test_define_domains():
    ...
    coarse_pelist = np.empty(shape=COARSE_NPES, dtype=np.int32)
    coarse_tile_id = 0
    coarse_whalo = 2
    coarse_ehalo = 2
    coarse_shalo = 2
    ...
    fine_npes = FINE_NPES
    fine_pelist = np.empty(shape=FINE_NPES, dtype=np.int32)
    fine_tile_id = 1
    fine_whalo = 2
    fine_ehalo = 2
    fine_shalo = 2
    ...
    npes = mpp.npes()
    global_pelist = np.empty(shape=npes, dtype=np.int32)
